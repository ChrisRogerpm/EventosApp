 ...
 */
public class MusicaFragment extends Fragment implements AdapterMusica.Click {
    ...
    int requestCount = 1;
    String URL_EVENTOS = MainActivity.HOST + "/api/ListaEventosMusica";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recycler_musica);
        ...
        GetData();
        //obtener recycler
        adapter = new AdapterMusica(eventoList, getActivity(), this);
    ...
    @Override
    public void onItemClick(AdapterMusica.ViewHolder holder, int posicion) {
        EventoDetalleFragment eventoDetalleFragment = new EventoDetalleFragment();
//        FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction()
        FragmentManager fragmentManager = getFragmentManager();
        fragmentManager.beginTransaction()
                .replace(R.id.fragment_container, eventoDetalleFragment).addToBackStack("tag")
                .commit();
    }
}
