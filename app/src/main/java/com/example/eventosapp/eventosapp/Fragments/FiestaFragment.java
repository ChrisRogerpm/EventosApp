...
import com.example.eventosapp.eventosapp.Adapters.AdapterFiesta;
 ...
 */
public class FiestaFragment extends Fragment implements AdapterFiesta.Click {
    ...
    int requestCount = 1;
    String URL_EVENTOS = MainActivity.HOST + "/api/ListaEventosFiesta";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recycler_fiesta);
        ...
        GetData();
        //obtener recycler
        adapter = new AdapterFiesta(eventoList, getActivity(), this);
    ...
    @Override
    public void onItemClick(AdapterFiesta.ViewHolder holder, int posicion) {
