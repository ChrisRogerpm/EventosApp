...
import com.example.eventosapp.eventosapp.Adapters.AdapterGastronomia;
 ...
 */
public class GastronomiaFragment extends Fragment implements AdapterGastronomia.Click {
    ...
    int requestCount = 1;
    String URL_EVENTOS = MainActivity.HOST + "/api/ListaEventosGastronomia";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recycler_gastronomia);
        ...
        GetData();
        //obtener recycler
        adapter = new AdapterGastronomia(eventoList, getActivity(), this);
    ...
    @Override
    public void onItemClick(AdapterGastronomia.ViewHolder holder, int posicion) {
