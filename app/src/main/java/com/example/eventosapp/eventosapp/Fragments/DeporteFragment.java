...
import com.example.eventosapp.eventosapp.Adapters.AdapterDeporte;
 ...
 */
public class DeporteFragment extends Fragment implements AdapterDeporte.Click{
    ...
    int requestCount = 1;
    String URL_EVENTOS = MainActivity.HOST + "/api/ListaEventosDeporte";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = v.findViewById(R.id.recycler_deporte);
        ...
        GetData();
        //obtener recycler
        adapter = new AdapterDeporte(eventoList, getActivity(), this);
    ...
    @Override
    public void onItemClick(AdapterDeporte.ViewHolder holder, int posicion) {
